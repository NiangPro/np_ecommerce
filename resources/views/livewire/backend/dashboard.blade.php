                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="name-avatar d-flex align-items-center pr-2">
                                <div class="avatar mr-2 flex-shrink-0">
                                    <img
                                        src="backend/vendors/images/photo3.jpg"
                                        class="border-radius-100 box-shadow"
                                        width="50"
                                        height="50"
                                        alt=""
        ...
        <div class="col-lg-4 col-md-12 mb-20">
            <div class="card-box height-100-p pd-20 min-height-200px">
                <div class="max-width-300 mx-auto">
                    <img src="backend/vendors/images/upgrade.svg" alt="" />
                </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-20">
            <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                <div class="img pb-30">
                    <img src="backend/vendors/images/medicine-bro.svg" alt="" />
                </div>
                <div class="content">
        ...
        <div class="col-md-4 mb-20">
            <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                <div class="img pb-30">
                    <img src="backend/vendors/images/remedy-amico.svg" alt="" />
                </div>
                <div class="content">
        ...
        <div class="col-md-4 mb-20">
            <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                <div class="img pb-30">
                    <img src="backend/vendors/images/paper-map-cuate.svg" alt="" />
                </div>
                <div class="content">
